...
public:
    WebSocketClient(int socket_fd) : sock(socket_fd) {}
    ...
    void handle() {
        ...
        while (true) {
            ...
            if (opcode == 0x1 || opcode == 0x2) {
                ...
                const char *response_text = "text received";
...
private:
    ...
    void accept_client() {
        ...
        if (sock < 0) {
            ...
            //vTaskDelay(pdMS_TO_TICKS(100)); // Avoid CPU spin
            accept_client();
            return;
        }
        ...
        xTaskCreate([](void *param) {
            WebSocketClient client((int)(intptr_t)param);
            client.handle();
        }, "handle_client", 8192, (void *)(intptr_t)sock, 5, NULL);

        // Recursively accept the next client
        accept_client();
    }
...
public:
    void start() {
        ...
        accept_client(); // Start recursion instead of while(true)
    }
};
